...
if ($tags) {
 ...
 ?>
	...
	<h3><?php echo esc_html_e('Related Articles', 'dotlife' ); ?></h3><br class="clear"/>
    <?php
       ...
       $image_thumb = '';
		...
		if(has_post_thumbnail(get_the_ID(), 'dotlife-blog'))
		{
		    $image_id = get_post_thumbnail_id(get_the_ID());
		    $image_thumb = wp_get_attachment_image_src($image_id, 'dotlife-blog');
		}
    ?>
					...
					?>
					    <div class="post_img static">
						    ...
						    <div class="post_img_hover classic <?php if(!empty($tg_enable_lazy_loading)) { ?>lazy<?php } ?>">
						     	<?php 
							     	$blog_featured_img_url = get_the_post_thumbnail_url($post, 'dotlife-blog'); 
							     	$blog_featured_img_data = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), "dotlife-blog" );
								...
								?>
						     	<?php echo dotlife_get_post_format_icon(get_the_ID()); ?>
				    ...
				    <div class="post_header_wrapper">
						...
						<div class="post_button_wrapper">
							<div class="post_attribute">
								<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><span class="ti-timer ti_icon"></span><?php echo date_i18n(DOTLIFE_THEMEDATEFORMAT, get_the_time('U')); ?></a>
						    </div>
						</div>
						<?php
							}
