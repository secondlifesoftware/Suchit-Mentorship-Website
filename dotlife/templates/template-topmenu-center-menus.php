...
<div class="top_bar <?php if(!empty($page_menu_transparent)) { ?>hasbg<?php } ?>">
    <div class="standard_wrapper">
    	...
    	<?php
    	    ...
    	    $tg_retina_transparent_logo = get_theme_mod('tg_retina_transparent_logo', dotlife_get_demo_logo('tg_retina_transparent_logo'));
        ...
        <div id="menu_wrapper">
			...
			?>
						...
						<div class="header_cart_wrapper">
						    ...
						    <a class="tooltip" href="<?php echo esc_url($cart_url); ?>" title="<?php esc_html_e('View Cart', 'dotlife' ); ?>"><span class="ti-shopping-cart"></span></a>
						</div>
						<?php
						}
						?>
