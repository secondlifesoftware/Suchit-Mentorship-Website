...
if ( function_exists( 'add_image_size' ) ) { 
	...
	add_image_size( 'dotlife-video-grid', 700, 393, true );
	...
	add_image_size( 'dotlife-gallery-grid', intval($pp_gallery_grid_image_width), intval($pp_gallery_grid_image_height), $image_crop );
	...
	add_image_size( 'dotlife-gallery-masonry', intval($pp_gallery_masonry_image_width), intval($pp_gallery_masonry_image_height), $image_crop );
	...
	add_image_size( 'dotlife-gallery-list', intval($pp_gallery_list_image_width), intval($pp_gallery_list_image_height), $image_crop );

	add_image_size( 'dotlife-album-grid', 660, 913, true );
	...
	add_image_size( 'dotlife-blog', intval($pp_blog_image_width), intval($pp_blog_image_height), $image_crop );
	...
	add_image_size( 'dotlife-blog-grid', intval($pp_blog_grid_image_width), intval($pp_blog_grid_image_height), $image_crop );
}

add_action( 'after_setup_theme', 'dotlife_woocommerce_support' );

function dotlife_woocommerce_support() {
