...
if(DOTLIFE_THEMEDEMO && isset($_GET['sidebar']))
{
...
if(empty($page_show_title))
{
    ...
    if(is_product())
    {
	    ...
	    $page_tagline = '<a href="'.get_permalink($shop_page_id).'"><span class="ti-arrow-left"></span>&nbsp;'.esc_html__('Back to shop', 'dotlife' ).'</a>';
    }
    else
    {
	    $cart_page_id = get_option( 'woocommerce_cart_page_id' );
	    $page_tagline = '<a href="'.get_permalink($cart_page_id).'"><span class="ti-bag"></span>&nbsp;'.esc_html__('View cart', 'dotlife' ).'</a>';
    }
