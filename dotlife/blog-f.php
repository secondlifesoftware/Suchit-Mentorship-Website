...
dotlife_set_page_content_class('blog_wrapper');
...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post_wrapper">
		...
		<?php	
		    ...
		    {
		     	$small_image_url = wp_get_attachment_image_src($image_id, 'dotlife-blog-hd', true);
		?>
		    <div class="post_img static">
			    ...
			    <div class="post_img_hover classic blog_f <?php if(!empty($tg_enable_lazy_loading)) { ?>lazy<?php } ?>">
			     	<?php 
				     	$blog_featured_img_url = get_the_post_thumbnail_url($post, 'dotlife-blog-hd'); 
				     	$blog_featured_img_data = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), "dotlife-blog-hd" );
